...
import 'package:musicplayer/view/widgets/cmn_design_widget.dart';
import 'package:musicplayer/view/widgets/favoritebutton.dart';
...
class PlayNowScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    WidgetsBinding.instance.addPersistentFrameCallback((timeStamp) {
      context.read<PlayNowController>().ss();
      ...
      body: SafeArea(
        child: Center(
          child: Padding(
            ...
            child: Consumer<PlayNowController>(builder: (context, value, child) {
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Text(
                                  songModel[value.currentIndex].artist.toString() ==
                                          "<unknown>"
                                      ? "<unknown>" 
                                      : songModel[currentIndex].artist.toString(),
                                  overflow: TextOverflow.ellipsis,
                                )
                              ],
                            ),
                          ...
                          SizedBox(
                            child: FavoriteBut(
                                song: SongListScreen.allSongs[value.currentIndex]),
                          )
                        ],
                      ),
                      const SizedBox(
